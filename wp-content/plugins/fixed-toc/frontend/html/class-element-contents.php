...
class Fixedtoc_Element_Contents extends Fixedtoc_Element {
	...
	protected function set_attrs() {
		$this->attrs = array( 'id' => 'ftwp-contents', 'class' => $this->get_cls() // 'data-height' => fixedtoc_get_val( 'contents_fixed_height' )
);
		
		// if ( fixedtoc_is_true( 'in_post' ) ) {
		// $this->attrs ['data-in_post_height'] = fixedtoc_get_val( 'contents_height_in_post' );
		// }
	}
