<?php
/*
 * Plugin Name: Fixed TOC |  VestaThemes.com
...
/**
 * Define debug mode.
 * Don't forget to false after developmented.
 *
 * @since 3.0.1
 */
define( 'FTOC_DEBUG', (bool) fixedtoc_get_option( 'developer_debug' ) );
